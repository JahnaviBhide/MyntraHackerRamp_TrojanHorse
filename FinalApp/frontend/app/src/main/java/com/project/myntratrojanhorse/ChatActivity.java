...
public class ChatActivity extends AppCompatActivity {
    ...
    LinearLayout layout;
    boolean exit = false;
    public final static String APP_ID = "287621d57d700e2532a0534d3c921686f";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        visitorButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                progressDialog.setCancelable(false);
                progressDialog.show();
                Kommunicate.init(ChatActivity.this, APP_ID);
                Kommunicate.loginAsVisitor(ChatActivity.this, new KMLoginHandler() {
                    @Override
    ...
    public void initLoginData(String userId, String password, final ProgressDialog progressDialog) {
        ...
        Kommunicate.login(ChatActivity.this, user, new KMLoginHandler() {
            @Override
            public void onSuccess(RegistrationResponse registrationResponse, Context context) {
